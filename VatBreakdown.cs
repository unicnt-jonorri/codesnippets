...
private void ReportFooter1_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
	...
	if (colSource != null)
	{
		...
		{
			AddOrUpdateTax(taxList, invLine.Vat, invLine.VatAmount, (invLine._PriceCur != 0.0 ? invLine._PriceCur : (-1)*invLine.NetAmount), invLine.VatPct);
		}
	}

	label1.Text = RenderTaxListText(taxList);      
}
...
public string RenderTaxListText(IEnumerable<TaxEntry> taxes)
{
	...
	sb.Append("Samantekt á Virðisaukaskatti\n");
